    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Student Center</h1>
          <p className="text-muted">Manage your students and communicate with them easily</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
          ...
          <p className="mt-6 text-center text-sm text-muted">
            By signing in, you agree to manage your students responsibly.
          </p>
        </div>
      </div>
    </div>
